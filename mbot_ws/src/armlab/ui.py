...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.rdoutMousePixels.setGeometry(QtCore.QRect(429, 525, 131, 20))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Ubuntu Mono"))
        ...
        self.rdoutRGB.setGeometry(QtCore.QRect(740, 525, 121, 20))
        self.rdoutHSV = QtGui.QLabel(self.centralwidget)
        self.rdoutHSV.setGeometry(QtCore.QRect(740, 550, 121, 20))
        font = QtGui.QFont()
        font.setFamily(_fromUtf8("Ubuntu Mono"))
        font.setPointSize(12)
        font.setBold(True)
        ...
        self.rdoutHSV.setFont(font)
        self.rdoutHSV.setTextFormat(QtCore.Qt.AutoText)
        self.rdoutHSV.setObjectName(_fromUtf8("rdoutHSV"))
        self.RGBValueLabel = QtGui.QLabel(self.centralwidget)
        self.RGBValueLabel.setGeometry(QtCore.QRect(570, 525, 180, 17))
        self.HSVValueLabel = QtGui.QLabel(self.centralwidget)
        self.HSVValueLabel.setGeometry(QtCore.QRect(570, 550, 180, 17))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.RGBValueLabel.setFont(font)
        self.RGBValueLabel.setObjectName(_fromUtf8("RGBValueLabel"))
        self.HSVValueLabel.setFont(font)
        self.HSVValueLabel.setObjectName(_fromUtf8("HSVValueLabel"))
        self.PixelCoordLabel = QtGui.QLabel(self.centralwidget)
        self.PixelCoordLabel.setGeometry(QtCore.QRect(268, 525, 144, 17))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.rdoutRGB.setText(_translate("MainWindow", "(H,S,V)", None))
        self.RGBValueLabel.setText(_translate("MainWindow", "RGB:", None))
        self.HSVValueLabel.setText(_translate("MainWindow", "HSV:", None))
